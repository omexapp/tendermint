...
var (
	...
	DefaultLogPath     = os.ExpandEnv("$HOME/.omexchaind")
	defaultLogFileName = "omexchaind.log"
...
func (cfg *Config) SetRoot(root string) *Config {
	...
	// omexchain change LogFile base on cfg.BaseConfig.RootDir
...
func DefaultMempoolConfig() *MempoolConfig {
	return &MempoolConfig{
		...
		// ABCI Recheck
		Size:        2000,               // omexchain memory pool size(max tx num)
